...
public class PeekCmd
{
    ...
    {
        if (Objects.requireNonNull(ModuleManager.getModuleByName("Peek")).isToggled() && Objects.requireNonNull(ModuleManager.getModuleByName("Peek")).getSetting(2).asToggle().state)
        {
    ...
    public static class PeekCommand extends CommandBase implements IClientCommand
    {
        ...
        {
            if (ModuleManager.getModuleByName("Peek").isToggled() && Objects.requireNonNull(ModuleManager.getModuleByName("Peek")).getSetting(2).asToggle().state)
            {
