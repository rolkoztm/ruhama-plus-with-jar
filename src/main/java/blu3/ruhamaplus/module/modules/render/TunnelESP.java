...
public class TunnelESP extends Module
{
    ...
    {
        float r = (float) (this.getSetting(2).asSlider().getValue() / 255.0D);
        float g = (float) (this.getSetting(3).asSlider().getValue() / 255.0D);
        float b = (float) (this.getSetting(4).asSlider().getValue() / 255.0D);
        float a = (float) (this.getSetting(5).asSlider().getValue() / 255.0D);
    ...
    private void scan(Chunk c)
    {
        if (this.isToggled())
        {
            ...
            {
                max = (int) this.getSetting(1).asSlider().getValue();
